    ...
    },
    {
      ...
      accessor: (book: IBook) => (
        <div className="flex space-x-1">
          <button
            className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-primary hover:text-primary-foreground hover:bg-primary transition-colors focus:outline-none"
