...
const BoughtBookDetailsPage: React.FC = () => {
  ...
  useEffect(() => {
    if (error || !data?.saleBooksContracts) {
      const errorMessage =
        error?.message ||
        "The sale contract you're looking for doesn't exist or has been removed.";
  ...
  if (isLoading)
    return <LoadingSpinner message="Loading bought book details" />;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-100 text-black font-sans">
      {/* Header */}
      <div className="bg-white px-10 py-6  border-gray-200">
              ...
              <div className="relative w-full md:w-48 h-64 flex-shrink-0 overflow-hidden">
                ...
                <div className="absolute top-0 right-0 m-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-md">
                  <p className="text-sm font-medium">
                    Rs. {saleContract.bookId.originalAmount}
                  </p>
                </div>
              </div>
              <div className="p-6 w-full md:w-2/3">
                <h2 className="text-2xl font-bold mb-2">
                  {saleContract.bookId.name}
                </h2>
                ...
                <div className="mt-4">
                  ...
                  <p className="text-gray-700">
                    {saleContract.bookId.description ||
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center">
                  <span className="inline-flex items-center justify-center h-10 w-10 text-2xl font-semibold">
                    ₹
                  </span>
                </div>
                <div>
                  ...
                  <p className="font-medium">
                    Rs. {saleContract.price.toFixed(2)}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {formatDate(saleContract.sale_date)}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {formatDate(saleContract.created_at)}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-10">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {saleContract.ownerId.phoneNumber || "N/A"}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-10">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-500">CONTACT</p>
                      <p className="font-medium">
                        {saleContract.buyerId.phoneNumber || "N/A"}
                      </p>
                    </div>
                  </div>
                </div>
...
export default BoughtBookDetailsPage;
