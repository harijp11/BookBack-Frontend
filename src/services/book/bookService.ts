...
export const getAllPaginatedBooks = async (
  ...
  try {
    ...
    const response = await UserAxiosInstance.get<BookListResponse>(
      "/user/book",
      {
        params: queryParams,
...
export const getAllPaginatedAdminBooks = async (
  ...
  try {
    ...
    const response = await adminAxiosInstance.get<BookListResponse>(
      "/admin/book",
      {
        params: queryParams,
        paramsSerializer: (params) => {
...
export async function addUserNotifyForBook(
  bookId: string
): Promise<Omit<BookResponse, "book">> {
   const response = await UserAxiosInstance.patch(
